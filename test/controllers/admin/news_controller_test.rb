...
class Admin::NewsControllerTest < ActionController::TestCase
  ...
  test "should create admin_news" do
    assert_difference('Admin::News.count') do
      post :create, admin_news: { content: @admin_news.content, cover: @admin_news.cover, status: @admin_news.status, title: @admin_news.title }
    end
  ...
  test "should update admin_news" do
    patch :update, id: @admin_news, admin_news: { content: @admin_news.content, cover: @admin_news.cover, status: @admin_news.status, title: @admin_news.title }
    assert_redirected_to admin_news_path(assigns(:admin_news))
  end
